      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <ul class="contact-details">
            <li><a href="{{ url('/login') }}"><i class="fa fa-sign-in"></i> Application Login</a></li>
          </ul>
          <!-- End Social Links -->
        </div>
      </div>
  ...
  <div class="navbar navbar-default navbar-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.html"><img alt="" src="{{ asset("static/images/margo.png") }}"></a>
      </div>
