  ...
  <div id="main-slide" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img class="img-responsive" src="{{ asset("/static/images/slider/bg1.jpg") }}" alt="slider">
      ...
      <!--/ Carousel item end -->
      <div class="item">
        <img class="img-responsive" src="{{ asset("/static/images/slider/bg2.jpg") }}" alt="slider">
        <div class="slider-content">
          <div class="col-md-12 text-center">
            <h2 class="animated4">
      ...
      <!--/ Carousel item end -->
      <div class="item">
        <img class="img-responsive" src="{{ asset("/static/images/slider/bg3.jpg") }}" alt="slider">
        <div class="slider-content">
          <div class="col-md-12 text-center">
    ...
    <div id="content" class="full-sections">
      ...
      <div class="section" style="padding-top:60px; padding-bottom:60px; border-top:0; border-bottom:0; background:#fff;">
        <div class="container">
          ...
          <!-- Some Text -->
          <p class="text-center">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem
          ...
          <ul id="portfolio-list" data-animated="fadeIn">
            <li>
              <img src="{{ asset("/static/images/portfolio-1/1.png") }}" alt="" />
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <!-- Some Text -->
              <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has to been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen
                book. It has survived not only five cent, but also the leap into electronic typesetting, remaining essentially unchanged. It was popular in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, more recently with
